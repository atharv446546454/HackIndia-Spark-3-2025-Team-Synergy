...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $minit = $conn->real_escape_string($_POST['minit']);
    ...
    $sql = "INSERT INTO customer (Dob, Age, FirstName, Minit, LastName, email, password) 
            VALUES ('$dob', $age, '$firstName', '$minit', '$lastName', '$email', '$password')";
